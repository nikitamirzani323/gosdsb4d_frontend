<script>
    ...
    const firebaseConfig = {
        ...
        databaseURL:
            "https://united-rope-233010-default-rtdb.asia-southeast1.firebasedatabase.app",
...
<div class="row" style="margin-top:-10px;">
    <div class="col-sm-6">
        <div class="card" style="background-color:#e91e65;border:none;">
            <div
                class="card-header"
                style="padding: 0px;margin:0px;background-color:none;"
            >
                <table class="table" style="margin-bottom: -5px;">
                    <thead>
                        ...
                        <tr style="background-color: #e91e65;">
                            <th
                                width="*"
                                style="text-align: left;vertical-align:top;font-size:12px;color:white;"
                                >TIME</th
                            >
                            <th
                                NOWRAP
                                style="text-align: right;vertical-align:top;font-size:12px;color:white;"
                                >{day_next_draw}, 03.00PM</th
                            >
                        </tr>
                    </thead>
                </table>
            ...
            <div
                class="card-body"
                style="margin: 0px;padding:5px;background-color: #e91e65;"
            >
    ...
    <div class="col-sm-6">
        <div
            class="card"
            style="padding:0px;margin:0px;background-color:none;border:none;"
        >
            <div
                class="card-header"
                style="padding: 0px;margin:0px;background-color:none;"
            >
                <table class="table" style="margin-bottom: -5px;">
                    <thead>
                        <tr
                            style="background-color: #ffd401;border-style: none;border-bottom-color: #ffd401;"
                        >
                            <th
                                colspan="4"
                                style="text-align: center;vertical-align: top;font-size: 30px;color:#020c13;"
                                >NEXT DRAWING</th
                            >
                        </tr>
                        <tr style="background-color: #ffd401;">
                            <th
                                width="*"
                                style="text-align: left;vertical-align:top;font-size:12px;color:#020c13;"
                                >TIME</th
                            >
                            <th
                                colspan="2"
                                NOWRAP
                                style="text-align: right;vertical-align:top;font-size:12px;color:#020c13;"
                                >{night_next_draw}, 21.00PM</th
                            >
                        </tr>
                    </thead>
                </table>
            ...
            <div
                class="card-body"
                style="margin: 0px;padding:5px;background-color:#ffd401;"
            >
        ...
        <table class="table">
            <thead>
                ...
                >
                    <th
                        width="*"
                        style="text-align: left;vertical-align:top;font-size:15px;color:#020c13;"
                        >CURRENT DRAW</th
                    >
                    <th
                        NOWRAP
            ...
            <tbody style="border-top:none;">
                ...
                >
                    <td
                        style="text-align: center;vertical-align:middle;font-size: 18px;font-weight: bold;color:#020c13;"
                        >1st Prize</td
                    >
                    <td
                        style="text-align: center;vertical-align:top;font-size: 15px;"
                    >
                        <img
                            width={size_image}
                            src={night_img_1_prize1}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_2_prize1}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_3_prize1}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_4_prize1}
                            alt=""
                        />
                    </td>
                </tr>
                ...
                >
                    <td
                        style="text-align: center;vertical-align:top;font-size: 18px;font-weight: bold;color:#020c13;"
                        >2nd Prize</td
                    >
                    <td
                        style="text-align: center;vertical-align:top;font-size: 15px;"
                    >
                        <img
                            width={size_image}
                            src={night_img_1_prize2}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_2_prize2}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_3_prize2}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_4_prize2}
                            alt=""
                        />
                    </td>
                </tr>
                ...
                >
                    ...
                    >
                        <img
                            width={size_image}
                            src={night_img_1_prize3}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_2_prize3}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_3_prize3}
                            alt=""
                        />
                        <img
                            width={size_image}
                            src={night_img_4_prize3}
                            alt=""
                        />
                    </td>
                </tr>
