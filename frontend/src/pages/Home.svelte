        ...
        <table class="table">
            <thead>
                ...
                <tr style="background-color: #8bd3dd;">
                    ...
                    <th NOWRAP width="50%" style="text-align: right;vertical-align:top;font-size:15px;">27-Oct-2021, 02.30pm</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table class="table">
            <thead>
                ...
                <tr style="background-color: #fe98a3;">
                    <th width="*" style="text-align: left;vertical-align:top;font-size:15px;">CURRENT DRAW</th>
                    <th NOWRAP width="50%" style="text-align: right;vertical-align:top;font-size:15px;">27-Oct-2021, 21.30pm</th>
                </tr>
            </thead>
            <tbody>
                <tr style="background-color: #f2f7f5;">
