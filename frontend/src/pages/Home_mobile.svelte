...
<div class="card" style="padding:0px;margin:0px;background-color:none;border:none;">
    <div class="card-header" style="padding:0px;margin:0px;background-color:none;border-bottom:none;">
        <table class="table" style="margin-bottom: none;">
            <tr style="background-color: #3e266d;border-style: none;border-bottom-color: none;">
                <th colspan="2" style="text-align: center;vertical-align: top;font-size: 20px;color:white;">NEXT DRAWING</th>
            </tr>
...
<table class="table">
    <thead>
        <tr style="background-color: #3e266d;border-style: none;border-bottom-color: #3e266d;">
            <th colspan="4" style="text-align: center;vertical-align: top;font-size: 20px;color:white;">SDSB4D DAY</th>
        </tr>
        <tr style="background-color: #3e266d;">
...
<div class="card" style="padding:0px;margin:0px;background-color:none;border:none;">
    <div class="card-header" style="padding: 0px;margin:0px;background-color:none;">
        <table class="table" style="margin-bottom: none;">
            <tr style="background-color: #f9da7c;border-style: none;border-bottom-color: none;">
                <th colspan="2" style="text-align: center;vertical-align: top;font-size: 20px;">NEXT DRAWING</th>
            </tr>
            <tr style="background-color: #f9da7c;border-bottom-color: none;">
                <th width="*" style="text-align: left;vertical-align:top;font-size:12px;">TIME</th>
                <th NOWRAP style="text-align: right;vertical-align:top;font-size:12px;">{night_next_draw}, 21.30PM</th>
            </tr>
        </table>
      </div>
    <div class="card-body" style="margin: 0px;padding:5px;">
